...
public class AddressBook {
	...
	public void sortAddressBook() {
		...
		for (Entry<String, ArrayList<Contacts>> book : addressBookMap.entrySet()) {
			ArrayList<Contacts> sortedList = book.getValue().stream().sorted((e1, e2) -> e1.getFirstName().compareTo(e2.getFirstName()))
					.collect(Collectors.toCollection(ArrayList<Contacts>::new));
