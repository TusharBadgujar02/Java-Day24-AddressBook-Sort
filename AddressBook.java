...
public class AddressBook {
	...
	public void sortAddressBook() {
		...
		{
			case 1 :
				for (Entry<String, ArrayList<Contacts>> book : addressBookMap.entrySet()) {
					ArrayList<Contacts> sortedList = book.getValue().stream().sorted((e1, e2) -> e1.getFirstName().compareTo(e2.getFirstName())).collect(Collectors.toCollection(ArrayList<Contacts>::new));
			...
			case 2 :
				for (Entry<String, ArrayList<Contacts>> book : addressBookMap.entrySet()) {
					ArrayList<Contacts> sortedList = book.getValue().stream().sorted((e1, e2) -> e1.getAddress().getCity().compareTo(e2.getAddress().getCity())).collect(Collectors.toCollection(ArrayList<Contacts>::new));
					operations.displayAddressBook(book.getKey(), sortedList);
				}
				break;
			...
			case 3 :
				for (Entry<String, ArrayList<Contacts>> book : addressBookMap.entrySet()) {
					ArrayList<Contacts> sortedList = book.getValue().stream().sorted((e1, e2) -> e1.getAddress().getState().compareTo(e2.getAddress().getState())).collect(Collectors.toCollection(ArrayList<Contacts>::new));
					operations.displayAddressBook(book.getKey(), sortedList);
				}
				break;
			...
			case 4 :
				for (Entry<String, ArrayList<Contacts>> book : addressBookMap.entrySet()) {
					ArrayList<Contacts> sortedList = book.getValue().stream().sorted((e1, e2) -> e1.getAddress().getZip().compareTo(e2.getAddress().getZip())).collect(Collectors.toCollection(ArrayList<Contacts>::new));
					operations.displayAddressBook(book.getKey(), sortedList);
				}
				break;
	...
	public void editAddressBook() {
		...
		for (Entry<String, ArrayList<Contacts>> entry : addressBookMap.entrySet()) {
